...
class SharedStorage(private var context: ReactApplicationContext) : ReactContextBaseJavaModule(context) {
    ...
    fun set(message: String?) {
        ...
        editor.apply()
        val intent = Intent(currentActivity!!.applicationContext, NewAppWidget::class.java)

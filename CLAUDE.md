...
Use this flow for any new Expo-based project (generates native folders, skips Expo Go):
...
# Step 5 — Subsequent development (JS-only changes)
# Custom dev client is already installed; this just starts Metro
npx expo start
```

> After Step 4 you never need Expo Go. Fast refresh works as normal via your own binary.
